<?php $pageTitle = 'Ajouter Entraînement – Admin'; $controller = 'back_entrainement'; ?>
<?php require __DIR__ . '/../../layouts/back_header.php'; ?>

<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6"><h1 class="m-0">Ajouter un Entraînement</h1></div>
            <div class="col-sm-6">
            ...
            <div class="col-md-8">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-plus mr-2"></i>Nouvel entraînement</h3>
                    </div>
                    <form method="POST" action="<?= BASE_PATH ?>/index.php?controller=back_entrainement&action=create">
                        <div class="card-body">
                            <?php if (!empty($errors)): ?>
